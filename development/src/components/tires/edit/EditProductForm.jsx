...
export default class EditProductForm extends Component {
    ...
    handleSubmit = (event) => {
        ...
        if (tireController.isValidInput(this.state)) {
            tireController.editTire(this.state._id, this.state)
                .then((res) => {
                    notificator.showInfo('Successfully edited product!');
            ...
            <main>
                ...
                <section className="unauthorized-section">
                    <section className="unauthorized-inner">
                        <p className="body-text">Access denied! You have no permissions to edit products!</p>
